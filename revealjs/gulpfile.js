    ...
    let tests = Promise.all( testFiles.map( filename => {
        return new Promise( ( resolve, reject ) => {
            qunit.runQunitPuppeteer({
                ...
                // added '--disable-gpu' to prevent protocolTimeout error: https://github.com/puppeteer/puppeteer/issues/12637
                puppeteerArgs: ['--allow-file-access-from-files', '--no-sandbox', '--disable-gpu']
            })
                .then(result => {
